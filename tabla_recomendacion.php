...
if ((isset($_POST["enviado"])))
  {
   ...
   $sqlu1 = "UPDATE cruce set plan='$plan' where id='$id_cruce'";
   $resultsqlu1 = pg_query($conectar,$sqlu1);

   if ($resultsqlu1)
         header('Location: tabla_recomendacion.php?mensaje=1');
   else
         header('Location: tabla_recomendacion.php?mensaje=2');
...
?>
        ...
        <td bgcolor="#EEEEEE" align=center>
        <font FACE="Century Gothic" SIZE=2 color="#000000"> <a href="recomendacion.php?id_cruce=<?php echo $id_cruce; ?>""  onclick="carga()"> <img src="../img/codigo1.png" border=0 width=30 height=30></a></font>
        </td>
        </tr>
<?php
			   }
